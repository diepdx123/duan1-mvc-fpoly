    ...
    <div class="others">
        <form action="/search" method="POST">
            <div class="input-group input-group-button" style="margin-top: 20px;">
                <input type="text" id="search-friends" name="search" class="form-control" placeholder="Tìm kiếm"
                    required>
                <div class="input-group-append">
                    <button class="btn btn-primary waves-effect waves-light" type="sunmit"><i
